...
if(isset($_POST["export"]))
{
 ...
 else
 {
  ...
  $header = array("ID", "PBNO", "MEMID", "LAST NAME", "FIRST NAME", "MIDDLE NAME", "CONTACT NO", "BRANCH", "BRANCH CODE", "REGS DATE", "TIME", "ISREGISTERED", "IsBDAYmodified");
