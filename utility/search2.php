...
<head>
    ...
    <title>UPDATE MEMBER'S BIRTH DATE</title>
</head>
<body>
            ...
            $.ajax({
					...
					success: function(res){
                        if(res.status == "success"){
                            ...
                            .then(() => {
                                let bday = data[1].value.split('-');
                                bday = bday[1] + '/' + bday[2] + '/' + bday[0];
                                
                                $("#trStatus-"+data[0].value).find(".bdayInfo").text(bday);
                                $(".updateBdayModal").modal('hide');
                            });
                        }
					}
				});
