    ...
    <ul class="sidebar-menu" data-widget="tree">
      ...
      <?php
        if($_SESSION['admin'] == 1) : ?>
          ...
          <li class=""><a href="accounts.php"><i class="fa fa-users"></i> <span>Accounts</span></a></li>
          ...
          <li class=""><a href="#config" data-toggle="modal"><i class="fa fa-cog"></i> <span>Configuration</span></a></li>
          <li class=""><a href="#raffle" data-toggle="modal" onclick="getSequence('getSequence')"><i class="fa fa-ticket"></i> <span>Raffle Sequence</span></a></li>
        <?php else: ?>
          <li class=""><a href="report.php"><i class="fa fa-users"></i> <span>Votes</span></a></li>
        <?php endif ?>      
